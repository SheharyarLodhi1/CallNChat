...
public class VideoChatDisplayActivity extends ChatDisplayActivity {
    ...
    private void requestPermissions() {
        ...
        String requiredCameraPermission = Manifest.permission.CAMERA;
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, requiredCameraPermission)) {
            displayAlertDialog(this, "Camera Permissions", "Remember, to communicate you must enable Camera permissions");
        }

        ActivityCompat.requestPermissions(this, new String[]{requiredAudioPermission, requiredCameraPermission}, 2);
    }
